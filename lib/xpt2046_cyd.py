...
class xpt2046:
    ...
    def get_coords(self):
        ...
        if int(raw_x) != 0 and int(raw_y) != 0:
            if self.portrait:
                x = self.screen_width - (
                    ((int(raw_y) - int(self.cal_y0)) * int(self.screen_width))
                    // (int(self.cal_y1) - int(self.cal_y0))
                )
                y = ((int(raw_x) - int(self.cal_x0)) * int(self.screen_height)) // (
                ...
                y = ((int(raw_y) - int(self.cal_y0)) * int(self.screen_height)) // (
                    int(self.cal_y1) - int(self.cal_y0)
                )
            return x, y
        else:
